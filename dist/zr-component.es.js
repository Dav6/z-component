import './assets/index.718d38d6.css';
...
const Ao = K({
  ...
  setup(e, { emit: v }) {
    const t = e;
    je((a) => ({
      "1288b9fc": a.fixedWidth,
      "182d7f7a": a.fixedChildrenWidth
    }));
    let u = he();
    const y = B(() => () => {
      let a = [];
...
}), Vo = /* @__PURE__ */ ie(ko, [["__scopeId", "data-v-e349a92a"]]), Co = q(Vo), xo = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Co
}, Symbol.toStringTag, { value: "Module" }));
function be(e) {
