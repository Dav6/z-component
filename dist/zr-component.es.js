import './assets/index.b5933813.css';
...
const ie = (e, v) => {
  ...
  setup(e, { emit: v }) {
    ...
    const h = U(!0), S = B(() => {
      ...
      return r = r.join(" "), i ? r = "" : A.value = yn.toString(
        r,
        {
...
const Vn = {
          ...
          (_(!0), $(Q, null, ae(e.list, (m, i) => {
            ...
            return _(), $(Q, { key: i }, [
              (_(), z(ye(j(u)(m)), {
                ...
                onClick: Ie((a) => A("onClick", { data: m, index: i }), ["stop"]),
              ...
              e.isDivided && ((r = e.list) == null ? void 0 : r.length) - 1 != i ? (_(), $("div", Vn)) : ce("", !0)
            ], 64);
          }), 128))
        ]),
        _: 1
  ...
  setup(e, { emit: v }) {
    ...
    return (A, h) => (_(), z(ye(t), tt(nt(A.$attrs)), ve({ _: 2 }, [
      ae(j(y)(), (S, c) => ({
        name: S.name,
        fn: X((n) => [
          de(A.$slots, S.name, {
  ...
  setup(e, { emit: v }) {
    ...
    return (y, A) => (_(), z(ye("el-dialog"), tt(nt(y.$props)), ve({ _: 2 }, [
      ae(j(u)(), (h, S) => ({
        name: h.name,
        fn: X((c) => [
          de(y.$slots, h.name, {
...
const Ao = K({
  ...
  setup(e, { emit: v }) {
    const t = e;
    je((a) => ({
      "575b7fde": a.fixedWidth,
      "7fbc811f": a.fixedChildrenWidth
    }));
    let u = he();
    const y = B(() => () => {
      let a = [];
    ...
    const A = B(() => {
      ...
      var o;
      let a = [], g = t == null ? void 0 : t.buttonClass;
...
}), Vo = /* @__PURE__ */ ie(ko, [["__scopeId", "data-v-25c7c6f2"]]), Co = q(Vo), xo = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Co
}, Symbol.toStringTag, { value: "Module" }));
function be(e) {
...
function De(e, v, t) {
  return ut() ? De = Reflect.construct.bind() : De = function(y, A, h) {
    var S = [null];
    S.push.apply(S, A);
...
var Io = /* @__PURE__ */ function(e) {
  ...
  function t(u) {
    var y;
    return rt(this, t), y = v.call(this, 'JSONPath should not be called with "new" (it prevents return of (unwrapped) scalar values)'), y.avoidNew = !0, y.value = u, y.name = "NewError", y;
  }
  return it(t);
}(/* @__PURE__ */ Le(Error));
...
Z.prototype._trace = function(e, v, t, u, y, A, h, S) {
  ...
  if ((typeof m != "string" || S) && v && me.call(v, m))
    ...
    if (m === "$")
      ...
      if (this.currPreventEval)
        throw new Error("Eval [(expr)] prevented in JSONPath expression.");
      a(this._trace(Xe(this._eval(m, v, t[t.length - 1], t.slice(0, -1), u, y), i), v, t, u, y, A, h));
    } else if (m[0] === "@") {
      ...
      var d = m.split(","), O = No(d), b;
      try {
        for (O.s(); !(b = O.n()).done; ) {
          var k = b.value;
          a(this._trace(Xe(k, i), v, t, u, y, A, !0));
        }
      } catch (M) {
        O.e(M);
      } finally {
...
Z.prototype._slice = function(e, v, t, u, y, A, h) {
  if (!!Array.isArray(t)) {
    ...
    for (var r = [], a = m; a < i; a += n) {
      var g = this._trace(Xe(a, v), t, u, y, A, h, !0);
...
var Lo = function(v, t, u) {
  ...
  return it(e, [{
    ...
    value: function(t) {
      ...
      return De(Function, y.concat([n])).apply(void 0, _o(h));
    }
  }]), e;
}();
Z.prototype.vm = {
...
}), zo = /* @__PURE__ */ ie(Ro, [["__scopeId", "data-v-fc266ff5"]]), Ho = q(zo), $o = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Ho
...
const ma = {
  ...
  setup(e, { emit: v }) {
    ...
    fe(() => t.sectionData, (f, s) => {
      var V, x;
      const w = f;
      ((V = w.selection) == null ? void 0 : V.length) > 0 ? (m.value = !0, i.value = (x = w.selection) == null ? void 0 : x.length) : (m.value = !1, i.value = 0), ct(() => {
      });
    }, {
      deep: !0
    });
...
const Ea = { class: "file-item" }, Pa = ["onClick"], Fa = K({
  ...
  setup(e, { emit: v }) {
    ...
    const u = Re(ze), { appContext: y } = Be(), A = B(() => {
                  ...
                  return [
                    L("div", za, [
                      N(O, {
                        ...
                        src: (w = m.value) != null && w.uid ? j(Xa) : j(Ge),
                        size: "100% 100%"
                      }, null, 8, ["src"])
                    ]),
                    L("div", Ha, W((V = m.value) != null && V.name ? (x = m.value) == null ? void 0 : x.name : "\u70B9\u51FB\u6216\u5C06\u6587\u4EF6\u62D6\u62FD\u5230\u8FD9\u91CC\u4E0A\u4F20"), 1)
                  ];
                }),
                _: 1
