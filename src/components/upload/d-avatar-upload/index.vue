        ...
        <template #default>
            <div class="d-avatar-upload-image-box" :style="imageStyleCOM">
                ...
                <d-el-image
                        ...
                        :src="_file.url" size="100% 100%" :previewList="isHaveFile?[_file.url]:[]"
...
watch(() => props.modelValue, (value, preValue) => {
        ...
        if (_value?.url) {
            ...
            isHaveFile.value = true;
        }
        if (_value && (typeof _value == 'string')) {
            _file.value.url = _value;
            _file.value.key = _value;
            isHaveFile.value = true;
        }

        // console.log('_file.value',_file.value)
        // 只需要一张 ，防止上传第二张 ，清空列表
        fileList.value = [];
